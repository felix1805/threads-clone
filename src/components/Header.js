  ...
  return (
    <header>
      ...
      <div className="button-container">
        <button className={viewThreadsFeed ? 'current' : null} onClick={() => setViewThreadsFeed(true)}>Threads
        </button>

        <button className={!viewThreadsFeed ? 'current' : null} onClick={() => setViewThreadsFeed(false)}>Replies
        </button>
